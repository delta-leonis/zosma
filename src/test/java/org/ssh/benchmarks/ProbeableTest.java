...
public class ProbeableTest {
  ...
  public void getProbes() {
    final ProbeablePublisher<Void> subject = new ProbeablePublisher<>();
    subject.flux()
  ...
  public void probeBefore() throws InterruptedException {
    ...
    final ProbeablePublisher<Long> subject = new ProbeablePublisher<>();
    ...
    final DescriptiveMeasurement<Long> expectation = new SimpleMeasurement<>(5L, "Before");
  ...
  public void probeAfter() throws InterruptedException {
    ...
    final Long input = 5L;
    //setup an expectation
    final DescriptiveMeasurement<Double> expectation = new SimpleMeasurement<>(Math.log(input), "After");
    // add a probe which'll trigger the latch if the measurement is as expected
