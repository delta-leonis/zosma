package io.leonis.zosma.math.algebra;
 ...
 *
 * - Closure:        if a and b are elements of F, then a + b is an element of F - Associativity:
 * if a, b, and c are elements of F, then (a+b)+c = a+(b+c) if a, b, and c are elements of F, then
