 ...
 */
@AllArgsConstructor
public class BarGraph<C extends MeasurementContextViewModel<? extends MeasurementContext>, R extends RangedMeasurement<? extends Number>> extends ProgressBar implements RxComponent<C> {
