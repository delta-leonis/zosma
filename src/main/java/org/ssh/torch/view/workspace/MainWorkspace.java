...
/**
 * Not actually an AbstractWorkspace, since that one only works when TorchImpl has been started.
 * @author jeroen.dejong
 */
@Torch(name = "MainWorkspace", constructible = false)
public class MainWorkspace extends AbstractWorkspace implements Lifecycle {
    ...
    protected void construct() {
        ...
        this.addPrerequisite("Loading WorkspaceWizard", () -> this.addWindow(new WorkspaceWizardModal()));
