 ...
 *
 * @param <A> The type of object (subject) which can interpret instructions in this strategy.
 * @param <C> The type of command (predicate) which can be issued by this strategy.
