package org.ssh.math.statistics.distributions;
...
public class GaussianDistribution implements Distribution<INDArray> {
     ...
     *
     * @param collection The {@link Collection} to calculate the covariance for as an {@link INDArray}.
    ...
    /**
     * Calculates the value of the Gaussian error function. See
     * <a href="http://www.ams.org/journals/mcom/1969-23-107/S0025-5718-1969-0247736-4/S0025-5718-1969-0247736-4.pdf">
     * here</a> for implementation details. The value of this function may cancel when extremely close to 0.
     *
