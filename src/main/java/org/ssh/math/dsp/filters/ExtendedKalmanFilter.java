 ...
 * applications. The implementation is based off of notes and equations which can be found
 * <a href="https://en.wikipedia.org/wiki/Extended_Kalman_filter#Discrete-time_predict_and_update_equations">
 * here</a>.
 *
 * @author Rimon Oz
 */
public interface ExtendedKalmanFilter extends Filter<INDArray> {
     ...
     * @param processNoise                The {@link Distribution} of process noise.
     ...
     *
     * @param stateTransition               A {@link BiFunction} which takes as its first argument
     *                                      the previous state, and the control input as its second
