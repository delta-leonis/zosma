 ...
 *
 * This class subscribes on a stream of {@link Jsonable JSONifiable} data and publishes it to a websocket
 *
 * @author Rimon Oz
 */
@Slf4j
public class WebSocketSubscriber<J extends Jsonable> implements Subscriber<J> {
    ...
    public void onNext(final J jsonable) {
        this.outputPublisher.onNext(jsonable.toJson());
    }
